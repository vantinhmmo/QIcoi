...
import { ColorPropType, Keyboard, Image, Modal, Picker, Platform, Text, TextInput, TouchableOpacity, TouchableWithoutFeedback, View, } from 'react-native';
...
export default class RNPickerSelect extends PureComponent {
    ...
    resetData(placeholderText) {
        var value = { label: placeholderText, value: '' }
        this.setState({
            selectedItem: value
        });
    }
    ...
    renderTextInputOrChildren() {
        ...
        return (
            <View pointerEvents="box-only" style={[containerStyle, Common.justifyCenter, Common.alignItmCenter]}>
                <TextInput
                    style={this.props.callType == 'AddBid' ?
                        [
                            Platform.OS === 'ios' ? style.inputIOS : style.inputAndroid,
                            this.getPlaceholderStyle(),
                            AppCommon.h5,
                            Colors.drakDefaultFnColor,
                        ]
                        :
                        [
                            Platform.OS === 'ios' ? style.inputIOS : style.inputAndroid,
                            this.getPlaceholderStyle(),
                            Colors.defaultFnColor,
                        ]
                    }
        ...
        return (
            <View style={[defaultStyles.viewContainer, style.viewContainer]}>
                <Picker
                    ...
                    mode="dropdown"
                >
                    {/* <Picker.Item style={Platform.OS == 'android' ? [Common.paddingHorizontal15] : []} label="Hotels" value="Hotels" />
