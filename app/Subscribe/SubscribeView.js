...
export default class SubscribeView extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            select_iap: '',
            iOSPrice: '39.99',
            iOSQuatumOneYear: "resonize.qicoil.trial.annual",
            androidPrice: '39.99',
            androidQuatumOneYear: "resonize.quantum.trial.annual",
        }
    ...
    render() {
        ...
        return (
            <View style={[AppCommon.mainContainer, Colors.whiteBgColor]}>
                <Notification screen='SubscribeView' />
                        ...
                        <View style={[AppCommon.container, Common.paddingHorizontal30]}>
                            ...
                            <View style={[Common.marginTop120, Common.justifyCenter, Common.alignItmCenter]}>
                                <TouchableHighlight
                                    ...
                                    <Text style={[AppCommon.h4, Colors.whiteFnColor, Input.fontBold]}>Try Free & Subscribe</Text>
                                </TouchableHighlight>
                            </View>
                            <View style={[Common.marginTop15, Common.justifyCenter, Common.alignItmCenter]}>
                                <Text style={[AppCommon.bodyFont, Colors.whiteFnColor, Input.textCenter, Input.textBold]}>Just {Platform.OS == 'ios' ? this.state.iOSPrice : this.state.androidPrice} per year after 7-day trial</Text>
                            </View>
                            <View style={[Common.marginTop15, Common.justifyCenter, Common.alignItmCenter]}>
